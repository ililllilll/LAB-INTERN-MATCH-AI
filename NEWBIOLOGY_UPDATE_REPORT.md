...
교과목과 인턴 연결 자료는 이후 제공된 DGIST 공식 PDF를 교수명 기준으로 연결했다.

- 2025 추천 코스트리: 21명에게 추천 과목 근거 추가
- 2026 하계 인턴 참여 연구실 자료: 17명에게 인턴 업무 근거 추가
- PDF에 등재되지 않은 교수에게는 임의의 과목이나 인턴 업무를 생성하지 않고 빈 배열을 유지
- PDF에 포함된 이메일, 전화번호와 사진은 데이터베이스에 옮기지 않음
...
- 뉴바이올로지 전임교원 22명 중 추천 과목 표시 가능: 21명
- 2025 추천 코스트리에 미등재: 요나스 페릭스 교수
- 뉴바이올로지 전임교원 22명 중 인턴 업무 표시 가능: 17명
- 2026 인턴 참여 연구실 PDF에 미등재: 김민석, 남창훈, 이송이, 이재민, 정찬 교수
- DGIST 전체 추천 과목 카드: 172개 → 193개
- DGIST 전체 인턴 업무 카드: 125개 → 142개
